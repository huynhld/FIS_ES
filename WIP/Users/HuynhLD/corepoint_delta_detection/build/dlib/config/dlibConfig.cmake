...
set(dlib_LIBRARIES ${dlib_LIBRARIES} "-lpthread;/usr/lib64/libnsl.so;/usr/lib64/libSM.so;/usr/lib64/libICE.so;/usr/lib64/libX11.so;/usr/lib64/libXext.so;/usr/lib64/libgif.so;/usr/lib64/libpng.so;/usr/lib64/libjpeg.so;/usr/lib64/libsqlite3.so")
set(dlib_LIBS      ${dlib_LIBRARIES} "-lpthread;/usr/lib64/libnsl.so;/usr/lib64/libSM.so;/usr/lib64/libICE.so;/usr/lib64/libX11.so;/usr/lib64/libXext.so;/usr/lib64/libgif.so;/usr/lib64/libpng.so;/usr/lib64/libjpeg.so;/usr/lib64/libsqlite3.so")
